...
jQuery.fn.timelinr = function(options){
	...
	settings = jQuery.extend({
		...
		issuesDiv: 					'#timedetail',			// value: any HTML tag or #id, default to #issues
	...
	$(function(){
		...
		if(settings.orientation == 'horizontal') {	
			...
			var defaultPositionDates = parseInt($(settings.datesDiv).css('marginTop').substring(0,$(settings.datesDiv).css('marginTop')));
		}
