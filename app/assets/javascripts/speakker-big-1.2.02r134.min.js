...
jQuery(function ($) {
    ...
    projekktor = $p = function () {
        ...
        function PPlayer(srcNode, cfg, onReady) {
            ...
            this.config = new projekktorConfig("1.2.02");
            ...
            this._prepareMedia = function (data) {
                ...
                for (var index in data.file) {
                    ...
                    data.file[index].type = data.file[index].type.replace(/x-/, "");
            ...
            this._canPlay = function (type, platform, streamType) {
                ...
                for (var i in checkFor) {
                    ...
                    if (typeof checkFor[i] == "string") {
                        ...
                        if ($.inArray(checkFor[i].replace(/x-/, "").toLowerCase() || "", checkIn) > -1) {
...
jQuery(function (a) {
    ...
    $p.utils = {
        ...
        ieVersion: function () {
            ...
            while (d.innerHTML = "<!--[if gt IE " + (++b) + "]><i></i><![endif]-->", c[0]) {}
    ...
    projekktorPluginInterface.prototype = {
        ...
        deconstruct: function () {
            ...
            a.each(this._appliedDOMObj, function () {
                ...
                a(this).unbind().remove()

            })

        },

        applyToPlayer: function (c, f, e) {
            ...
            var d = f || "container",
                ...
                b = c.attr("class") || this.name;

            this._pageDOMContainer[d] = a("[" + this.getDA("host") + "='" + this.pp.getId() + "'][" + this.getDA("func") + "='" + d + "']"), this._childDOMContainer[d] = this.playerDom.find("[" + this.getDA("func") + "='" + d + "'],." + this.getCN(this.name));

            if (this._pageDOMContainer[d].length > 0) {

                this._pageDOMContainer[d].removeClass("active").addClass("inactive");

                return this._pageDOMContainer[d]

            }

            if (this._childDOMContainer[d].length == 0) {

                c.removeClass(b).addClass(this.pp.getNS() + b).removeClass("active").addClass("inactive").attr(this.getDA("func"), d).appendTo(this.playerDom);

                this._childDOMContainer[d] = c;
            ...
            if (e == true) {
                ...
                this._childDOMContainer[d].addClass("active").removeClass("inactive")

            }

            return this._childDOMContainer[d]
        ...
        getActive: function (b) {

            return a(b).hasClass("active")
    ...
    "plugin_share": {
        ...
        "links": {
            ...
            "twitter": {
                ...
                "code": "http:\/\/twitter.com\/crunchpress"
            ...
            "facebook": {
                ...
                "code": "http:\/\/www.facebook.com\/crunchpress"
...
jQuery(function (a) {
    ...
    projekktorControlbar.prototype = {
        ...
        readyHandler: function (b) {
            ...
            if (this.getConfig("disableFade") == false) {
        ...
        showcbNow: function (d) {
            ...
            if ("ERROR".indexOf(this.pp.getState()) > -1 && instant != true) {
        ...
        showcb: function () {
            ...
            if ("IDLE|AWAKENING|ERROR".indexOf(this.pp.getState()) > -1 && instant != true) {

                return

            }

            if (!this.cb.hasClass("fade")) {
...
jQuery(function (a) {
    ...
    projekktorShare.prototype = {
        ...
        addTool: function (b, e) {
            ...
            if (this.playerDom.find("." + this.pp.getCssPrefix() + "shareicn_" + e).length == 0) {

                if (this.socialSidebar && b.buttonText) {

                    c = a(document.createElement("div")).html(b.buttonText).addClass(this.pp.getCssPrefix() + "socialbutton").appendTo(this.socialSidebar).show();

                    a(document.createElement("div")).addClass(this.pp.getCssPrefix() + "shareicn_" + e).prependTo(c)

                }

            } else {

                c = this.playerDom.find("." + this.pp.getCssPrefix() + "shareicn_" + e)
